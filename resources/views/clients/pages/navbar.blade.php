            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                        <h5 class="brand-name">SeneVentes</h5>
                    </div>
                        ...
                        <ul class="nav justify-content-end">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('show.panier.client')}}">
                                    <i class="fa fa-shopping-cart"></i> Cart <span id="cart-count">{{ count(session('cart', [])) }}</span>
                                </a>
                            </li>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('produitByCategorie',['id'=>$cat->id])}}"> {{$cat->categorie}} </a>
                        </li>
                        @endforeach
