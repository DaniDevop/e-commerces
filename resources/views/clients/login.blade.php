				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<a class="primary-btn" href="{{route('register.client')}}">Creer un compte</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
                    ...
                    @endif
						...
						<form class="row login_form" action="{{route('client.login')}}" method="POST" id="contactForm" >
                            @csrf
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" name="emailOrTel" placeholder="Identifiant" >
							</div>
							<div class="col-md-12 form-group">
