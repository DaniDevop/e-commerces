...
<body>
    ...
    <div class="login-container">
        <h4 class="text-primary">Creer un compte</h4>
        <hr>

        <form action="{{route('client.create.account')}}" method="POST">
            @csrf
            ...
            <div class="form-group">
                <label for="emailOrTel">Nom</label>
                <input type="text" name="nom" class="form-control" value="{{old('nom')}}" placeholder="Nom"  required/>
            </div>

            <div class="form-group">
                <label for="emailOrTel">Email</label>
                <input type="text" name="email" class="form-control" placeholder="Email" value="{{old('email')}}" />
            </div>

            <div class="form-group">
                <label for="emailOrTel">Téléphone</label>
                <input type="text" name="tel" class="form-control" placeholder="Numéro de téléphone" value="{{old('tel')}}"  required/>
            </div>
            <div class="form-group">
                <label for="emailOrTel">Adresse</label>
                <input type="text" name="adresse" class="form-control" placeholder="Adresse" value="{{old('adresse')}}"/>
            </div>

            <div class="form-group">
                <label for="password">Mot de passe</label>
                <input type="password" name="password" class="form-control" placeholder="Enter le mot de passe" value="{{old('password')}}" />
            </div>

            <div class="form-group">
                <label for="password">Confirmer le mot de passe</label>
                <input type="password" name="confirmation_password" class="form-control" value="{{old('confirmation_password')}}" placeholder="Enter le mot de passe" />
            </div>

            <button class="btn btn-primary" type="submit">Valider</button>
        </form>
         <a href="{{route('login.client')}}">Vous n avez pas de compte ?</a>
    </div>
