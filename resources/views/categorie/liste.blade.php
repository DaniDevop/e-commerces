...
<body>
    ...
    <div class="main-content">
        ...
        <div class="product-form">
            <form action="{{route('ajouter.categorie')}}" method="POST" enctype="multipart/form-data">
			...
			@if ($errors->any())
                ...
                <div class="form-group">
                    <input type="submit" name="addProduct" value="Ajouter-une-catégorie">
                </div>
            </form>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href=" {{route('details.categorie',['id'=>$categorie->id ])}} " class="edit-btn">Edit</a>
